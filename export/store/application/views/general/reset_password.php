			...
			<div class="container">
				<div class="col-md-5 ml-auto mr-auto">
					<div class="card card-login card-plain">
						<form class="form" method="POST" action="<?php echo base_url();?>index.php/general/reset_password_process">
							...
							<div class="card-body pt-0">
								...
								<span class="form-text text-white text-center">Password must be at least 6 characters long, have a number, an uppercase character and a lowercase character.</span>
								<div class="input-group no-border input-lg">
									<div class="input-group-prepend">
							...
							<div class="card-footer text-center">
								<button class="btn btn-primary btn-round btn-lg btn-block" type="submit">Go</button>
							</div>

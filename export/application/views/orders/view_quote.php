...
<div class="container_full bg_img_banner mt-5">
	<div class="content_wrapper">
		<div class="container-fluid">
			...
			<!-- Section -->
			<div class="container-fluid">
				<form action="<?php echo base_url();?>index.php/orders/save_new_quote" method="POST" id="new_order_form" novalidate>
				     <div class="mt-3 px-4 blackHeader">
				        <div class="row py-2">
				            ...
				            <div class="col-auto viewMailBtn"><button type="button" class="btn btn-warning btn-sm" onclick="open_modal('<?php echo $order_info[0]->order_id; ?>')">Send Email</button></div>
				        </div>
								        ...
								        <div class="table-responsive mt-4">
											<table class="table table-sm product_main_table product_table">
												...
												<tbody>
												    ...
												    <tr class="productRow">
												        <td><input disabled readonly type="text" class="form-control product_name" name="product_name[]" value="<?php echo $product->product_name; ?>"></td>
												        <td><input disabled readonly type="text" class="form-control product_volume" name="product_volume[]" value="<?php echo $product->product_volume; ?>"></td>
												        <td>
												            	<select disabled readonly class="form-control" name="category[]" id="category">
												            	    <option value=""></option>
												        ...
												        <td><input disabled readonly type="text" class="form-control product_comment" name="product_comment[]" value="<?php echo $product->product_comment; ?>"></td>
												        <td width="200px">
												            <div class="input-group">
                    											<span class="input-group-addon">$</span>
                    											<input disabled readonly type="text" class="form-control" name="amount[]" readonly value="<?php echo $product->amount; ?>">
                    										</div>
												        </td>
...
• RFP, INTERIM HALAL AND LOAD OUT DOCS TO BE EMAILED TO NACH FOOD CO PTY LTD (EXPORTER NO: 3518 AND EDI NO:2145) at email address: info@nachfoodco.com.au</textarea>
									    ...
									    <div class="row">   
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                ...
								                <input disabled type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $order_info[0]->customer_name; ?>">
								                    
								            </div> 
								          
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                <label>Request Number</label>
								                <input disabled type="text" class="form-control" id="request_number" name="request_number" value="<?php echo $order_info[0]->request_number; ?>" >
								            </div>
								        </div>

...
<div class="container_full bg_img_banner mt-5">
	<div class="content_wrapper">
		<div class="container-fluid">
			...
			<!-- Section -->
			<div class="container-fluid">
				<form action="<?php echo base_url();?>index.php/orders/update_quote" method="POST" id="new_order_form">
				     <input type="hidden" name="order_id" value="<?php echo $order_info[0]->order_id; ?>">
									...
									<div class="card-body">
								        <div class="row">
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                ...
								                <input type="text" class="form-control" id="reference_number" name="reference_number" value="<?php echo $order_info[0]->reference_number; ?>" >
								            </div>
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								            ...
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 supplier_address_wrap" >
								                ...
								                <input type="text" readonly class="form-control" name="supplier_address" id="supplier_address" value="<?php echo $order_info[0]->email_address; ?>">
								            </div>
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                <label>Date</label>
								                <input type="text" class="form-control datepicker" name="date" id="date" value="<?php echo date("d-m-Y",strtotime($order_info[0]->order_date)); ?>" >
								            </div>
								        </div>
								        <div class="table-responsive mt-4">
											<table class="table table-striped table-sm product_main_table product_table">
												<thead>
													<tr>
												...
												<tbody>
												    ...
												    <tr class="productRow">
												        <td><input type="hidden" name="order_product_id[]" value="<?php echo $product->order_product_id; ?>"><input type="text" class="form-control product_name" name="product_name[]" value="<?php echo $product->product_name; ?>"></td>
												        <td><input type="text" class="form-control product_volume" name="product_volume[]" value="<?php echo $product->product_volume; ?>"></td>
												        <td>
												        ...
												        <td><input type="text" class="form-control product_comment" name="product_comment[]" value="<?php echo $product->product_comment; ?>"></td>
												        <td width="200px">
												            <div class="input-group">
                    											<span class="input-group-addon">$</span>
                    											<input readonly type="text" class="form-control" name="amount[]" value="<?php echo $product->amount; ?>">
                    										</div>
												        </td>
												        <td width="170px"><div class="add_btns"><a href="javascript:void(0)" class="btn add_field_button" style="background-color:#16b708;color:#fff;">+</a><a href="javascript:void(0)" class="btn remove_field_button" style="background-color:#ff5426;color:#fff;margin-left:5px;">-</a></div></td>
												    </tr>
												    <?php } }else{ ?>
												    <tr class="productRow">
								        ...
								        <div class="row">
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                ...
								                <input type="text" class="form-control required" id="fob_fas" name="fob_fas" value="<?php echo $order_info[0]->fob_fas; ?>" required>
								                ...
								                <div class="table-responsive">
        											<table class="table table-striped table-sm product_table ">
        												<tbody>
        												    ...
        												    ?>
    												        <tr class="productRow">
    												            <td> <input type="text" class="form-control required" id="market" value="<?php echo $market; ?>" name="market[]" required></td>
    												            <td width="130px"><div class="add_btns"><a href="javascript:void(0)" class="btn add_field_button" style="background-color:#16b708;color:#fff;">+</a><a href="javascript:void(0)" class="btn remove_field_button" style="background-color:#ff5426;color:#fff;margin-left:5px;">-</a></div></td>
    												        </tr>
    												        <?php } }else{ ?>
    												        <tr class="productRow">
								        ...
								        <div class="row">
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                ...
								                <input type="text" class="form-control" id="shipment_period" name="shipment_period" value="<?php echo $order_info[0]->shipment_period; ?>">
								        ...
								        <div class="row">
								             <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                ...
								                <input type="text" class="form-control" id="payment_terms" name="payment_terms" value="<?php echo $order_info[0]->payment_terms; ?>">
								        ...
								        <div class="row">
    							            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3 ">
    							                ...
    							                <input type="text" class="form-control" id="port_loading" name="port_loading" value="<?php echo $order_info[0]->port_loading; ?>" >
    							            </div>
							            </div>
							           <div class="row">
    							            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3">
    							                <label>PORT OF DISCHARGE </label>
    							                <input type="text" class="form-control" name="port_discharge" id="port_discharge" value="<?php echo $order_info[0]->port_discharge; ?>">
    							            </div>
							           </div>
							           <div class="row">
								            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3 ">
								                <label>FINAL DESTINATION </label>
								                <input type="text" class="form-control" name="final_destination" id="final_destination" value="<?php echo $order_info[0]->final_destination; ?>">
								            </div>
								        </div>
...
• RFP, INTERIM HALAL AND LOAD OUT DOCS TO BE EMAILED TO NACH FOOD CO PTY LTD (EXPORTER NO: 3518 AND EDI NO:2145) at email address: info@nachfoodco.com.au</textarea>
									        ...
									        <div class="col-lg-12 mt-3">
									            ...
									            <textarea class="form-control" name="comments" style="height:100px" ><?php echo $order_info[0]->comments; ?></textarea>
									        </div>
									    </div>
									    <div class="row">   
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                <label>Customer Name </label>
								                <input type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $order_info[0]->customer_name; ?>">
								                    
								            </div> 
								          
								            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 mt-3 ">
								                <label>Request Number</label>
								                <input type="text" class="form-control" id="request_number" name="request_number" value="<?php echo $order_info[0]->request_number; ?>" >
								            </div>
								        </div>
									    <div class="text-end mt-3"><button type="submit" class="btn btn-info submit-button" onclick="validation()">Update and Close</button></div>
									</div>
								</div>
							</div>
							<!--Report widget end-->
...
function validation() {
    ...
    $( thisRow ).next('.productRow').find( '.customAlert' ).remove();
    $( thisRow ).next('.productRow').find( '.required' ).removeClass('error');

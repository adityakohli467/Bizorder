...
xhttp.onload = function () {
  ...
  json_records.forEach(raw => {
    ...
    if(raw.is_employee == 1){ var isEmployee = 'Yes'; }else{ var isEmployee = 'No'; }
    //  console.log(st);
   employeeList.add({
...
xhttp.open("GET", "userListController?role=3");
xhttp.send();
          ...
          document.getElementById("delete-record").addEventListener("click", function () {
              ...
              const xhttp = new XMLHttpRequest();
                xhttp.onload = function() {
                  ...
                  xhttp.open("GET", "userDeleteController?user_id="+emp_id+"&user_status=0&user_role=3");
                  xhttp.send(); 

...
addBtn.addEventListener("click", function (e) {
    ...
    if(errFlag == 0){ 
        ...
        var Fdata = new FormData(form);
            ...
            const xhttp = new XMLHttpRequest();
            xhttp.open("POST", "/employeeSubmitController");
            xhttp.onload = function() {
              ...
              const xhttp = new XMLHttpRequest();
                xhttp.onload = function() {
                    console.log(this.responseText);
                      ...
                      if(this.responseText == 'success'){
                          var msgIcon = 'success';
                          var msgTitle = 'Employee deleted successfully!';
                      }
                      else{
                          var msgIcon = 'error';
                          var msgTitle = 'Something went wrong!';
                  ...
                  xhttp.open("GET", "employeeDeleteController?emp_id="+emp_id+"&emp_status=0");
                  xhttp.send(); 
       ...
       document.getElementById("delete-record").addEventListener("click", function () {
              ...
              const xhttp = new XMLHttpRequest();
                xhttp.onload = function() {
                    console.log(this.responseText);
                      ...
                      if(this.responseText != 0 && this.responseText == 1){
                          var msgIcon = 'success';
                          var msgTitle = this.responseText+' Employee deleted successfully!';
                      }
                      else if(this.responseText != 0){
                          var msgIcon = 'success';
                          var msgTitle = this.responseText+' Employees deleted successfully!';
                      }
                      else{
                          var msgIcon = 'error';
                          var msgTitle = 'Something went wrong!';
                ...
                //   var emp_id = isdeleteid;
                  ...
                  xhttp.open("POST", "employeeMultipleDeleteController?emp_id="+ids_array+"&emp_status=0");
                  xhttp.send(); 

								...
								<table id="customers" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
									...
									<tbody>
										<?php if(!empty($costcenter)){
											foreach($costcenter as $company){ ?>
											<tr>
											     <td><?php echo $company->fullname; ?></td>
											      <td><?php echo $company->accounts_contact_number; ?></td>
											    ...
											    <?php 
													...
													else $phone=$company->telephone;
											    ?>
											    <td><?php echo $phone; ?></td>
											      <td><?php echo ($company->status == 0 ? 'Inactive' : 'Active'); ?></td>

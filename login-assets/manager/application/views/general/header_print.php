...
<title>Healthy Choices Catering</title>
	...
	<link href="<?php echo base_url();?>assets/css/bootstrap.print.css" rel="stylesheet" type="text/css">
		...
		<header class="main-header">
			<div class="container_header">
				<div class="logo d-flex align-items-center">
					<a href="#"><span class="logo-default"> <img src="<?php echo base_url();?>assets/images/logo.png" alt="" style="max-height:40px;"> </span> </a>
				</div>

...
<div class="container_full bg_img_banner mt-5">
								...
								<table class="table table-sm table-striped">
									...
									<tbody id="products_list">
										<?php foreach($products as $product){
											...
											echo "<tr>";
											echo "<td width=\"10%\">".$product->product_name."</td>";
											echo "<td width=\"20%\">";
 ...
 echo "<td width=\"15%\"><input type='checkbox' onChange='UpdatePrStatus(this)' class='toggle-demo' id=". $product->product_id." checked data-toggle='toggle' data-on='Enable' data-off='Disabled' data-offstyle='danger' data-onstyle='success'></td>";
                          } else {
 echo "<td width=\"15%\"><input type='checkbox' onChange='UpdatePrStatus(this)'  class='toggle-demo' id=". $product->product_id." data-toggle='toggle' data-on='Enable' data-off='Disabled' data-offstyle='danger' data-onstyle='success'></td>";
                           } 
					echo "</tr>";
     ...
     if($(obj).prop('checked')){
       ...
       console.log(product_status);
     	$.ajax({
			...
			url:'<?php echo base_url();?>index.php/general/update_product_status/'+product_status+'/'+product_id,

...
<div class="container_full bg_img_banner mt-5">
	<div class="content_wrapper">
		<div class="container-fluid">
			...
			<!-- Section -->
			<div class="container-fluid">
				<form action="<?php echo base_url();?>index.php/orders/edit_fronteend_orders/<?php echo $order_info[0]->order_id;?>" method="POST" id="new_order_form" novalidate>
					<div class="row mb-4">
						<!--Report widget start-->
						<div class="col-7">
								...
								<div class="card card-shadow">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-12"><?php echo empty($order_info[0]->approval_comments)?'No comments added':$order_info[0]->approval_comments;?></div>
										</div>
										<?php if(isset($order_info[0]->express_order_products) && $order_info[0]->express_order_products !='') { ?>
										<div class="row">
											<div class="col-12"><strong>Express Order Products</strong></div>
											<?php 
											$prod_list = explode(',', $order_info[0]->express_order_products);
											...
											<tbody>
												<form id="add_new_order">
													<?php 
														...
														if(isset($order_product_options) && !empty($order_product_options)){
														...
														<tr id="coupon_id">
															<td>Coupon Code</td>
															<td colspan="3"><input type="text" class="form-control" id="coupon_code" name="coupon_code" data-discount="" data-type="" value=""><div class="invalid-feedback">Invalid coupon code!</div></td>
														</tr>
														
															<tr>
																<td>Customer Name</td>
																<td colspan="3"><input type="text" class="form-control name" name="cust_firstname" value="<?php echo $order_info[0]->firstname;?>">
																<input type="hidden" class="form-control name" name="cust_id" value="<?php echo $order_info[0]->customer_id;?>">
																</tr>
																<tr>
																<td>Customer Email</td>
																<td colspan="3"><input type="text" class="form-control email" name="cust_email" value="<?php echo $order_info[0]->email;?>">
																</tr>
																
																	<tr>
																<td>Customer Telephone</td>
																<td colspan="3"><input type="text" class="form-control telephone" name="cust_telephone" value="<?php echo $order_info[0]->telephone;?>">
																</tr>
														    <tr>
															<td>Delivery Date</td>
															<td colspan="3"><input type="text" class="form-control datepicker" name="delivery_date" value="<?php echo date("d-m-Y",strtotime($order_info[0]->delivery_date));?>">
															</tr>
															<tr>
																<td>Delivery Time</td>
																<td colspan="3"><input type="text" class="form-control timepicker" name="delivery_time" value="<?php echo date("H:i",strtotime($order_info[0]->delivery_time));?>">
																</tr>
																...
																if(isset($order_info[0]->shipping_address_1) && $order_info[0]->shipping_address_1 !=''){
																    $addr = $order_info[0]->shipping_address_1;
																}else{
																    $addr = $order_info[0]->shipping_address_1.','.$order_info[0]->shipping_city .','.$order_info[0]->shipping_address_2 .','.$order_info[0]->shipping_postcode;
																    
																}
																?>
																<td colspan="3"><input type="text" class="form-control addr" name="delivery_addr" value="<?php echo $addr;?>">
																</tr>
																
																	<tr>
																<td>Company Name</td>
																<td colspan="3"><input type="text" class="form-control addr" name="company_name" value="<?php echo $order_info[0]->customer_company_name;?>" readonly>
																
																</tr>
																<tr>
																<td>Gate No</td>
																<td colspan="3"><input type="text" class="form-control addr" name="comp_addr" value="<?php echo $order_info[0]->shipping_gate_number;?>">
															
																</tr>
																
																<tr>
																<td>Building No</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_building_number" value="<?php echo $order_info[0]->shipping_building_number;?>" >
																</tr>
																	<tr>
																<td>Department Name</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_department_name" value="<?php echo $order_info[0]->shipping_department_name;?>" >
																</tr>
																
																	<tr>
																<td>Shipping level of building</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_level_of_building" value="<?php echo $order_info[0]->shipping_level_of_building;?>" >
																</tr>
																
																<tr>
																<td>Shipping room number</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_room_number" value="<?php echo $order_info[0]->shipping_room_number;?>" >
																</tr>
																
																<tr>
																<td>Shipping business name</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_business_name" value="<?php echo $order_info[0]->shipping_business_name;?>" >
																</tr>
																
																	<tr>
																<td>Shipping street number</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_street_number" value="<?php echo $order_info[0]->shipping_street_number;?>" >
																</tr>
																
																<tr>
																<td>Delivery contact name</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_delivery_contact_name" value="<?php echo $order_info[0]->shipping_delivery_contact_name;?>" >
																</tr>	
																<tr>
																<td>Delivery contact number</td>
																<td colspan="3"><input type="text" class="form-control addr" name="shipping_delivery_contact_number" value="<?php echo $order_info[0]->shipping_delivery_contact_number;?>" >
																</tr>
																...
																<tr>
																	...
																	<td colspan="3"><input type="text" class="form-control" name="delivery_notes" value="<?php echo $order_info[0]->comment;?>">
																	</tr>
																	<tr>
																		<td>Order Comments</td>
																		<td colspan="3"><input type="text" class="form-control" name="order_comments" value="<?php echo $order_info[0]->order_comments;?>"></td>
																	</tr>
																	
																	<tr>
																		<td>Delivery Fee</td>
																		<td colspan="3"><div class="input-group"><div class="input-group-prepend"><div class="input-group-text">$</div></div><input type="text" class="form-control" name="delivery_fee" value=""></div></td>
																	</tr>
				...
				$(document).ready(function(){
				  $("#products_list :input").prop("disabled", true);  
				});
					...
					function rebind_submit()
					{
						...
						$("body").on('click','.new-product-form',function(e){
							...
							if($("#cart-product-"+prod_id).length!=0){
								...
								$("#coupon_id").before("<tr id=\"cart-product-"+prod_id+"\"><td>"+prod_heading+prod_name+"</td><td>"+qty+"</td><td>$"+total.toFixed(2)+"</td><td><button type=\"button\" class=\"btn btn-danger\" onclick=\"remove_product_from_cart("+prod_id+")\"><i class=\"fa fa-remove\"></i></button></td></tr>");
							}
							$("#qty-"+prod_id).val('');
						...
						if(qty==0||isNaN(qty)){
							...
							$.ajax({
								...
								success:function(data){
									...
									var total=qty*price;
									//Check if product is already added; If it is, update quantity and total
									$("#coupon_id").before("<tr id=\"cart-product-"+prod_id+"\"><td>"+prod_name+"</td><td>"+qty+"</td><td>$"+total.toFixed(2)+"</td><td><button type=\"button\" class=\"btn btn-danger\" onclick=\"remove_product_from_cart("+prod_id+")\"><i class=\"fa fa-remove\"></i></button></td></tr>");
									$("#new_order_form").append("<input type=\"hidden\" name=\"qty["+prod_id+"]\" value=\""+qty+"\" id=\"hidden-product-"+prod_id+"\">");
									//Remove disabled if one value is entered
									$(".submit-button").prop('disabled',false);

						...
						<div class="col-6">
							...
							<div class="col-6">
								<div class="card card-shadow">
									...
									<div class="card-body">
								    <input type="hidden" name="order_count" id="orderCount" value="0">
											...
											<tbody>
												<form id="add_new_order">
													...
													<tr id="submit-button-row">
														<td colspan="4" class="text-right"><button type="submit" id="proceedBtn" class="btn btn-info submit-button" disabled>Proceed</button></td>
													</tr>
												</form>
											</tbody>
										</table>

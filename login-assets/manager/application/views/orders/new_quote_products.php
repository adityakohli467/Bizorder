			...
			<div class="container-fluid">
				<form action="<?php echo base_url();?>index.php/orders/new_quote_products" method="POST" id="new_order_form" novalidate>
					<div class="row mb-4">
						...
						<input type="hidden" name="customer_order_name" value="<?php echo $customer_order_name;?>">
						<input type="hidden" name="accounts_email" value="<?php echo $accounts_email;?>">
						<input type="hidden" name="customer_order_phone" value="<?php echo $customer_order_phone;?>">
						<input type="hidden" name="customer_order_email" value="<?php echo $customer_order_email;?>">
						<input type="hidden" name="delivery_contact" value="<?php echo $delivery_contact;?>">
						<input type="hidden" name="customer" value="<?php echo $customer;?>">
						<input type="hidden" name="customer_from" value="<?php echo $customer_from;?>">
			...
			<div class="modal-dialog modal-lg loader_backkground">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary loadingBtn" id="product_add" onclick="add_new_product_to_cart()">
							Save changes
						</button>
					</div>

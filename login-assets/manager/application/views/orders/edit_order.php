		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				<form action="<?php echo base_url();?>index.php/orders/edit_order_process/<?php echo $order_info->order_id;?>" method="POST" id="new_order_form" novalidate>
					<input type="hidden" name="ostatus" value="<?php echo $ostatus; ?>">
					<div class="row mb-4">
						<!--Report widget start-->
								...
								<div class="card card-shadow">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-12"><?php echo empty($order_info->approval_comments)?'No comments added':$order_info->approval_comments;?>
											<input type="hidden" name="order_count" id="orderCount" value="<?php echo count($order_product_options); ?>">
											</div>
										</div>
										<?php
								...
								echo "<td id=\"total-".$opo->order_product_id."\" data-price=\"".$opo->price."\">$".number_format($opo->total,2)."</td>";
														...
														<tr id="coupon_id">
														    ...
														    <tr>
																...
																<td colspan="3"><input type="text" class="form-control " name="delivery_telephone" id="delivery_telephone" value="<?php echo !empty($order_info->delivery_phone)?$order_info->delivery_phone:'';?>"></td>
															</tr>
															<tr>
																<td>Account Email</td>

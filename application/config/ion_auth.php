...
*/
$config['tables']['users']           = 'Global_users';
$config['tables']['groups']          = 'Global_roles';
$config['tables']['users_groups']    = 'Global_userid_to_roles';
...
$config['argon2_default_params']	= [
	'memory_cost'	=> defined('PASSWORD_ARGON2_DEFAULT_MEMORY_COST') ? PASSWORD_ARGON2_DEFAULT_MEMORY_COST : 1 << 16,  // 65536 - matches production
	'time_cost'	=> defined('PASSWORD_ARGON2_DEFAULT_TIME_COST') ? PASSWORD_ARGON2_DEFAULT_TIME_COST : 4,           // matches production
	'threads'	=> defined('PASSWORD_ARGON2_DEFAULT_THREADS') ? PASSWORD_ARGON2_DEFAULT_THREADS : 1                // matches production
];
...
$config['staff_group']                = 'staff';       // Default administrators,manager and staff group, use name
...
$config['forgot_password_expiration'] = 90000;                /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.

        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Total Number of Active Patients</h4>
            ...
            <div class="row" id="filter-card">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo base_url('Orderportal/Reports/activePatientsReport'); ?>" method="POST">
                                ...
                                <table class="table table-bordered table-hover align-middle reports-table" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:12%;">Active Patients</th>
                                            <th>Patient Names Active</th>
                                            <th style="width:11%;">Onboarded</th>
                                            <th style="width:11%;">Discharged</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if (!empty($days)): ?>
                                            <?php foreach ($days as $d): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo (int) $d['active']; ?></td>
                                                    <td><?php echo !empty($d['names']) ? htmlspecialchars(implode(', ', $d['names'])) : '&ndash;'; ?></td>
                                                    <td><?php echo (int) $d['onboarded']; ?></td>
                                                    <td><?php echo (int) $d['discharged']; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr><td colspan="5" class="text-center text-muted">No records found for the selected date range.</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
...
<form id="exportForm" action="<?php echo base_url('Orderportal/Reports/exportActivePatients'); ?>" method="POST" style="display:none;">

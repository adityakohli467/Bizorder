        ...
        <div class="container-fluid">
            ...
            <div class="row" id="filter-card">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo base_url('Orderportal/Reports/foodOrdersReport'); ?>" method="POST">
                                        ...
                                        <?php if (!empty($rows)): ?>
                                            <?php foreach ($rows as $r): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo (int) $r['patient_count']; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr><td colspan="2" class="text-center text-muted">No food orders found for the selected date range.</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
...
<form id="exportForm" action="<?php echo base_url('Orderportal/Reports/exportFoodOrders'); ?>" method="POST" style="display:none;">

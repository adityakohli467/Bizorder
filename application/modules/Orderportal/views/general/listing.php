                                           ...
                                           <?php } } ?>
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <div class="view">
                                                        <a class="btn btn btn-primary edit-item-btn" href="<?php echo base_url(); ?>index.php/<?php echo $controller_view."/".$row->$idName ?>">
                                                          View</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a class="btn btn btn-success edit-item-btn" href="<?php echo base_url(); ?>index.php/<?php echo $controller_edit."/".$row->$idName ?>">
                                                      Edit</a>
                                                    </div>
                                                    <div class="remove">
                                                      <button class="btn btn btn-danger remove-item-btn" data-rel="delete" data-rel-id="<?php echo  $row->$idName ?>" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Remove</button>
                                                    </div>
                                                </div>

!(function () {
    ...
    function p(e) {
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/hr-assets/images/flags/us.svg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/spain.svg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/germany.svg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/italy.svg")
                : "ru" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/russia.svg")
                : "ch" == e
                ? (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/china.svg")
                : "fr" == e && (document.getElementById("header-lang-img").src = baseURL+"/theme-assets/images/flags/french.svg"),
            localStorage.setItem("language", e),
            null == (y = localStorage.getItem("language")) && p(b),
            (e = new XMLHttpRequest()).open("GET", baseURL+"/theme-assets/lang/" + y + ".json"),
    ...
    function f() {
        ...
        !t ||
            ...
            ((o = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src=baseURL+"/theme-assets/images/logo-sm.png" alt="" height="22"></a>'),

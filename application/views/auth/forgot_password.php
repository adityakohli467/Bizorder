                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="alert alert-borderless alert-warning text-center mb-2 mx-2 " style="font-size: 12px;" role="alert">
                                ...
                                <div class="p-2">
                                   <?php echo form_open("auth/forgot_password");?>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="identity" name="identity" placeholder="Enter Email">
                                        </div>
                                  <div id="infoMessage"><?php echo $message;?></div>
                                        <div class="text-center mt-4">
                                            <button class="btn btn-orange w-100" type="submit">Send Reset Link</button>
                                        </div>
                                    <?php echo form_close();?>
                                </div>
                            </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password... <a href="/<?php echo $this->session->userdata('tenantIdentifier'); ?>" class="fw-semibold text-primary text-decoration-underline"> Login here </a> </p>
                        </div>

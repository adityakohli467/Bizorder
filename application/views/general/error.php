...
<head>
    ...
    <!-- custom Css-->
    <link href"/theme-assets/css/custom.min.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 pt-4">
                            <div class="mb-5 text-white-50">
                                <h1 class="display-5 coming-soon-text">Incorrect URL</h1>
                                <p class="fs-14">Please enter the correct login URL for your cafe in the browser. For example: bizadmin.com.au/<your organisation name>.
If the problem still persists, please contact bizadmin admin team.</p>
                                
                            </div>
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-4 col-lg-8">
                                    <div>
                                        <img src"/theme-assets/images/maintenance.png" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Bizadmin. Crafted with <i class="mdi mdi-heart text-danger"></i>
                            </p>
                        </div>
                    </div>
                </div>
